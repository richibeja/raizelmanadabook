...
export class Metadata {
  ...
  /**
   * Creates an OutgoingHttp@/app/components/Headers object that can be used with the http2 API.
   */
  toHttp2@/app/components/Headers(): http2.OutgoingHttp@/app/components/Headers {
    // NOTE: Node <8.9 formats http2 @/app/components/Headers incorrectly.
    const result: http2.OutgoingHttp@/app/components/Headers = {};
  ...
  /**
   * Returns a new Metadata object based fields in a given IncomingHttp@/app/components/Headers
   * object.
   * @param @/app/components/Headers An IncomingHttp@/app/components/Headers object.
   */
  static fromHttp2@/app/components/Headers(@/app/components/Headers: http2.IncomingHttp@/app/components/Headers): Metadata {
    const result = new Metadata();
    for (const key of Object.keys(@/app/components/Headers)) {
      // Reserved @/app/components/Headers (beginning with `:`) are not valid keys.
      if (key.charAt(0) === ':') {
        continue;
      }

      const values = @/app/components/Headers[key];
