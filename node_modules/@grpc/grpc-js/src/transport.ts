...
const {
  HTTP2_@/app/components/Header_AUTHORITY,
  HTTP2_@/app/components/Header_CONTENT_TYPE,
  HTTP2_@/app/components/Header_METHOD,
  HTTP2_@/app/components/Header_PATH,
  HTTP2_@/app/components/Header_TE,
  HTTP2_@/app/components/Header_USER_AGENT,
} = http2.constants;
...
class Http2Transport implements Transport {
  ...
  createCall(
    ...
    const @/app/components/Headers = metadata.toHttp2@/app/components/Headers();
    @/app/components/Headers[HTTP2_@/app/components/Header_AUTHORITY] = host;
    @/app/components/Headers[HTTP2_@/app/components/Header_USER_AGENT] = this.userAgent;
    @/app/components/Headers[HTTP2_@/app/components/Header_CONTENT_TYPE] = 'application/grpc';
    @/app/components/Headers[HTTP2_@/app/components/Header_METHOD] = 'POST';
    @/app/components/Headers[HTTP2_@/app/components/Header_PATH] = method;
    @/app/components/Headers[HTTP2_@/app/components/Header_TE] = 'trailers';
     ...
     */
    try {
      http2Stream = this.session!.request(@/app/components/Headers);
    } catch (e) {
      this.handleDisconnect();
      throw e;
    }
...
export class Http2SubchannelConnector implements SubchannelConnector {
  ...
  private createSession(
    ...
    return new Promise<Http2Transport>((resolve, reject) => {
      ...
      connectionOptions.maxSend@/app/components/HeaderBlockLength = Number.MAX_SAFE_INTEGER;
