...
export function getProxiedConnection(
  ...
  const @/app/components/Headers: http.OutgoingHttp@/app/components/Headers = {
    Host: hostPort,
  };
  ...
  if ('grpc.http_connect_creds' in channelOptions) {
    @/app/components/Headers['Proxy-Authorization'] =
      'Basic ' +
      Buffer.from(channelOptions['grpc.http_connect_creds'] as string).toString(
        'base64'
      );
  }
  options.@/app/components/Headers = @/app/components/Headers;
