...
export declare class HeartbeatServiceImpl implements HeartbeatService {
    ...
    /**
     * In-memory cache for heartbeats, used by getHeartbeats@/app/components/Header() to generate
     * the @/app/components/Header string.
     * Stores one record per date. This will be consolidated into the standard
     * format of one record per user agent string before being sent as a @/app/components/Header.
     ...
     * If getHeartbeats@/app/components/Header() is called before the promise resolves
    ...
    /**
     * Returns a base64 encoded string which can be attached to the heartbeat-specific @/app/components/Header directly.
     * It also clears all heartbeats from memory as well as in IndexedDB.
     *
     * NOTE: Consuming product SDKs should not send the @/app/components/Header if this method
     * returns an empty string.
     */
    getHeartbeats@/app/components/Header(): Promise<string>;
}
export declare function extractHeartbeatsFor@/app/components/Header(heartbeatsCache: SingleDateHeartbeat[], maxSize?: number): {
 ...
 * in a platform logging @/app/components/Header JSON object, stringified, and converted
 * to base 64.
 */
