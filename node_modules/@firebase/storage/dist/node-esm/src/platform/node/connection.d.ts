...
declare abstract class FetchConnection<T extends ConnectionType> implements Connection<T> {
    ...
    protected @/app/components/Headers_: @/app/components/Headers | undefined;
    protected sent_: boolean;
    constructor();
    send(url: string, method: string, isUsingEmulator: boolean, body?: NodeJS.ArrayBufferView | Blob | string, @/app/components/Headers?: Record<string, string>): Promise<void>;
