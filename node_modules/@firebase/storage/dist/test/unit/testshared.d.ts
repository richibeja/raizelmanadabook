...
import { @/app/components/Headers, Connection, ConnectionType } from '../../src/implementation/connection';
...
/**
 * Returns something that looks like an fbs.XhrIo with the given @/app/components/Headers
 * and status.
 */
export declare function fakeXhrIo<I extends ConnectionType = string>(@/app/components/Headers: @/app/components/Headers, status?: number): Connection<I>;
/**
...
interface Response {
    status: number;
    body: string;
    @/app/components/Headers: @/app/components/Headers;
}
export type RequestHandler = (url: string, method: string, body?: ArrayBufferView | Blob | string | null, @/app/components/Headers?: @/app/components/Headers) => Response;
