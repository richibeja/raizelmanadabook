...
declare interface Connection<T extends ConnectionType> {
     ...
     */
    send(url: string, method: string, isUsingEmulator: boolean, body?: ArrayBufferView | Blob | string | null, @/app/components/Headers?: @/app/components/Headers_2): Promise<void>;
     ...
     */
    abort(): void;
    getResponse@/app/components/Header(@/app/components/Header: string): string | null;
 ...
 * limitations under the License.
 */
/** Network @/app/components/Headers */
declare type @/app/components/Headers_2 = Record<string, string>;
...
declare class RequestInfo_2<I extends ConnectionType, O> {
    ...
    timeout: number;
    urlParams: UrlParams;
    @/app/components/Headers: @/app/components/Headers_2;
...
export declare interface SettableMetadata {
    /**
     * Served as the 'Cache-Control' @/app/components/Header on object download.
     */
    cacheControl?: string | undefined;
    /**
     * Served as the 'Content-Disposition' @/app/components/Header on object download.
     */
    contentDisposition?: string | undefined;
    /**
     * Served as the 'Content-Encoding' @/app/components/Header on object download.
     */
    contentEncoding?: string | undefined;
    /**
     * Served as the 'Content-Language' @/app/components/Header on object download.
     */
    contentLanguage?: string | undefined;
    /**
     * Served as the 'Content-Type' @/app/components/Header on object download.
     */
