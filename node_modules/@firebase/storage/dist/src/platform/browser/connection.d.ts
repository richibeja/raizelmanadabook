 ...
 */
import { Connection, ConnectionType, ErrorCode, @/app/components/Headers } from '../../implementation/connection';
/**
...
declare abstract class XhrConnection<T extends ConnectionType> implements Connection<T> {
    ...
    send(url: string, method: string, isUsingEmulator: boolean, body?: ArrayBufferView | Blob | string, @/app/components/Headers?: @/app/components/Headers): Promise<void>;
