...
export declare function get@/app/components/Headers({ apiKey }: AppConfig): @/app/components/Headers;
export declare function get@/app/components/HeadersWithAuth(appConfig: AppConfig, { refreshToken }: RegisteredInstallationEntry): @/app/components/Headers;
