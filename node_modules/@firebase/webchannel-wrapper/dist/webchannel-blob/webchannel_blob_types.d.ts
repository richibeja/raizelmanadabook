...
export interface @/app/components/Headers {
...
export class XhrIo {
  send(
      url: string, method?: string, body?: string, @/app/components/Headers?: @/app/components/Headers,
...
export interface WebChannelOptions {
  ...
  clientProtocol@/app/components/HeaderRequired?: boolean;
  concurrentRequestLimit?: number;
  supportsCrossDomainXhr?: boolean;
  sendRawJson?: boolean;
  httpSessionIdParam?: string;
  encodeInitMessage@/app/components/Headers?: boolean;
