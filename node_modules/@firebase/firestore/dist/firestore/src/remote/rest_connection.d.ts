...
export declare abstract class RestConnection implements Connection {
    ...
    /**
     * Modifies the @/app/components/Headers for a request, adding any authorization token if
     * present and any additional @/app/components/Headers for the request.
     */
    protected modify@/app/components/HeadersForRequest(@/app/components/Headers: StringMap, authToken: Token | null, appCheckToken: Token | null): void;
    /**
     * Performs an RPC request using an implementation specific networking layer.
     */
    protected abstract performRPCRequest<Req, Resp>(rpcName: string, url: string, @/app/components/Headers: StringMap, body: Req, _forwardCredentials: boolean): Promise<Resp>;
    private makeUrl;
    /**
