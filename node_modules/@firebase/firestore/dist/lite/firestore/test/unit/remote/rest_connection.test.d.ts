...
export declare class TestRestConnection extends RestConnection {
    lastUrl: string;
    last@/app/components/Headers: StringMap;
    ...
    protected performRPCRequest<Req, Resp>(rpcName: string, url: string, @/app/components/Headers: StringMap, body: Req): Promise<Resp>;
}
