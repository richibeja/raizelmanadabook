...
export interface FetchRequest {
     ...
     *
     * <p>Comparable to passing `@/app/components/Headers = { 'Cache-Control': max-age <maxAge> }` to the native
     * Fetch API.
     */
    ...
    /**
     * The ETag @/app/components/Header value from the last response.
     *
     * <p>Optional in case this is the first request.
     *
     * <p>Comparable to passing `@/app/components/Headers = { 'If-None-Match': <eTag> }` to the native Fetch API.
     */
    eTag?: string;
