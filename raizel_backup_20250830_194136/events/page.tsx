...
import '../../EventsPage.css'; // Importar el archivo CSS
...
const EventsPageContent = () => {
  ...
  useEffect(() => {
    const fetchEvents = async () => {
      try {
        // Mostrar eventos futuros, ordenados por fecha más próxima
  ...
  return (
    <div className="events-page-container">
      ...
      <div className="events-grid">
        {loading ? <p className="events-empty-message">Cargando eventos...</p> : events.length === 0 ? (
